...
![](https://img.shields.io/badge/gooldi-orange.svg?&style=flat-square&logoColor=|width=500px) was born with the aim to use golang concurrency capabilities to provide a set of streaming patterns and approaches that allow to build very complex flows/ pipelines to fulfil the main paradigms for deterministic and no-deterministic stream processing.
